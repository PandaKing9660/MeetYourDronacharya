...
const EditorAndPreview = ({ option, question_id }) => {
    ...
    const handlePreview = () => {
        if (editorRef.current) {
          setQuesData({ ...quesData, title: title, question: editorRef.current.getContent() });
    ...
    const handleSubmit = () => {
        ...
        if (editorRef.current && editorRef.current.getContent()) {
            if (option === 'question') {
                axios
                    .post( `${process.env.REACT_APP_BACKEND_URL}/ask-something/question/add`, {
                        by: user._id,
                        title: title,
                ...
                axios
                    .post( `${process.env.REACT_APP_BACKEND_URL}/ask-something/answer/add`, {
                        by: user._id,
                        title: title,
                        to: question_id,
