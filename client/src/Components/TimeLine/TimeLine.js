...
const TimeLine = () => {
  ...
  const [examCards, setExamCards] = useState ([
    {
      name: 'UPSC',
      description: 'Civil Services Exam, conducted by government of India to select candidates for high power government jobs. Exam has 3 sections, section one is Prelims where two exams are conducted, Mains where 8 exams are conducted and then a final interview.',
      imgLink: 'https://images.unsplash.com/photo-1593642634315-48f5414c3ad9?ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1169&q=80',
      events: [
    ...
    {
      name: 'CAT',
      description: 'CAT is used for selecting candidates for MBA programme, the exam consist of one paper consisting of 3 sections, namely Verbal Ability and Reading Comprehension, Data Interpretation and Logical Reasoning and Quantitative Ability.',
    ...
    {
      name: 'GRE',
      description: 'Graduate Record Examinations is a standardized test that is an admissions requirement for many graduate schools in US, Canada and few in other countries. Exam consist of 2 verbal reasoning, 2 quantitative reasoning, and research section',
      imgLink: 'https://images.unsplash.com/photo-1629218079827-3b28e2466725?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=687&q=80',
      events: [
        {
          date: '01/01/2021',
          info: 'Exam Date',
    ...
    {
      name: 'JEE',
      description: 'Joint Entrance Exam is considered to be most difficult exams for India, it is a test made to select students for IITs and NITs. The Exam has 2 parts Mains and Advance both are objective type exams testing Maths, Physics and Chemistry of students',
      imgLink: 'https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80',
      events: [
        {date: '01/01/2021', info: 'Exam Date', extra: ''},
        {date: '21/02/2021', info: 'Result Date', extra: ''},
